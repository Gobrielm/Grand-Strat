...
void PDP::_bind_methods() {
    ...
    ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "buy_orders"), "set_buy_orders", "get_buy_orders");
    ADD_PROPERTY(PropertyInfo(Variant::DICTIONARY, "sell_orders"), "set_sell_orders", "get_sell_orders");
...
Dictionary PDP::get_buy_orders() const {
    return buy_orders;
}

Dictionary PDP::get_sell_orders() const {
    return sell_orders;
}
...
void PDP::set_buy_orders(Dictionary p_buy_orders) {
    buy_orders = p_buy_orders;
}

void PDP::set_sell_orders(Dictionary p_sell_orders) {
